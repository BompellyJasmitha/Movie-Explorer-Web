...
Welcome to the **Movie Explorer Web**! This application allows users to explore trending movies, search for specific titles, and view detailed information, including trailers.
...
- **Trending Movies**: View a list of the most popular movies currently trending.
- **Search Functionality**: Search for movies by title.
- **Movie Details**: Click on a movie to view more details and watch the trailer.
